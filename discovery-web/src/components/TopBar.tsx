        ...
        <div className="px-4 lg:px-6 pb-3">
          {showSearchInput ? (
            ...
            <button
              ...
              className="flex items-center gap-2 w-full max-w-2xl py-2.5 px-3 bg-input-background rounded-xl text-sm text-muted-foreground/60 min-h-[44px] transition-colors hover:bg-accent focus:outline-none focus:ring-2 focus:ring-primary/30"
