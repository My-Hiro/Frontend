...
export function HomePage({
  ...
  useEffect(() => {
    ...
    // Stale-while-revalidate: render cached quickly, then refresh in background once.
          ...
          <CategoryStrip
            ...
            onStorePress={(storeId) => {
              void discoveryApi
                ...
                .catch(() => undefined);
              onStorePress(storeId, section.categoryId);
            }}
            onSeeMore={() => onCategoryPress(section.categoryId)}
          />
        );
      })}

      {/* Popular Products (after categories) */}
      <PopularProductsStrip
        className="mb-8"
        products={popularProducts}
        onViewAll={onPopularProductsViewAll}
