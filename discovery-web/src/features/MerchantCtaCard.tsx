...
const onboardingImageSrc = `${(process.env.NEXT_PUBLIC_BASE_URL || "/")}images/merchant-onboarding.png`;
const fallbackOnboardingImageSrc = `${(process.env.NEXT_PUBLIC_BASE_URL || "/")}images/merchant-onboarding.webp`;

export function MerchantCtaCard() {
  const merchantUrl =
    (process.env.NEXT_PUBLIC_MERCHANT_URL as string | undefined) ??
    defaultMerchantUrl;
